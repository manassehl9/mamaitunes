        ...
        <script>
            function initialize() {
                ...
                var marker = new google.maps.Marker({
                    ...
                    title:"Mamma's Itunu Restaurant"
                });
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        <h2 class="pricing-title">Our Menu List Affordable Pricing</h2>
                            ...
                            <div class="flexslider-container">
                                <div class="flexslider">
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <img src="{{ asset('/frontend/images/menu-gallery/menu4.png') }}" />
                                        </li>
                                        <li>
                                            <img src="{{ asset('/frontend/images/menu-gallery/menu5.png') }}" />
                                        </li>
                                        <li>
                                            <img src="{{ asset('/frontend/images/menu-gallery/menu6.png') }}" />
                                        </li>
                                        <li>
                                            <img src="{{ asset('/frontend/images/menu-gallery/menu7.png') }}" />
                                        </li>
                                        <li>
                                            <img src="{{ asset('/frontend/images/menu-gallery/menu8.png') }}" />
                                        </li>
                                        <li>
                                            <img src="{{ asset('/frontend/images/menu-gallery/menu9.png') }}" />
                                        </li>
                                        <li>
                                            <img src="{{ asset('/frontend/images/menu-gallery/menu10.png') }}" />
                                        </li>
                                        <li>
                                            <img src="{{ asset('/frontend/images/menu-gallery/menu11.png') }}" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
